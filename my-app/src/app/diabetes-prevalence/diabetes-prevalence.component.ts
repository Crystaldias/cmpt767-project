...
@Component({
  selector: 'app-diabetes-prevalence',
  templateUrl: './diabetes-prevalence.component.html',
  styleUrls: ['./diabetes-prevalence.component.scss'],
})
export class DiabetesPrevalenceComponent implements AfterViewInit {
  @Input()
