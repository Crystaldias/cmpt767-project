...
@Component({
  selector: 'app-median-age',
  templateUrl: './median-age.component.html',
  styleUrls: ['./median-age.component.scss'],
})
export class MedianAgeComponent implements AfterViewInit {
  @Input()
  ...
  ngAfterViewInit(): void {
    ...
    d3.csv("../assets/csv_agg/median_age.csv").then(data => this.drawBars(this.data));
    this.logData(); // Log the data
  }
