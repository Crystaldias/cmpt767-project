...
@Component({
  selector: 'app-cardiovasc-death-rate',
  templateUrl: './cardiovasc-death-rate.component.html',
  styleUrls: ['./cardiovasc-death-rate.component.scss'],
})
export class CardiovascDeathRateComponent implements AfterViewInit {
  @Input()
